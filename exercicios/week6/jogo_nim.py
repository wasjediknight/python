...
def usuario_escolhe_jogada(n, m):
    ...
    while Jogador > limitePecasRemovidasNaJogada or Jogador < 1:
...
def partida():
    ...
    while totalDePecas > 0:
        ...
        if turnoDoComputador:
            ...
            print("O computador tirou {} peça(s).".format(pecasRetiradas))
        else:
            pecasRetiradas = usuario_escolhe_jogada(totalDePecas, limitePecasPorJogada)
            print("Você tirou {} peça(s).".format(pecasRetiradas))
...
def main():
    ...
    partida() if modoDeJogo == 1 else torneio()
